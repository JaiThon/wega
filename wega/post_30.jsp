...
<html lang="en">
 ...
 <body onload="realtimeClock()">
    ...
    <div class="container">
      ...
      <h1 class="mt-4 mb-3">Isn't it fuddle only me?
        <small>by
...
<img class="d-flex mr-3 rounded-circle" src="data:image/jpeg;base64," alt="img" width="50" height="50">
          <p>Posted on April 23, 2018 at 14:15 PM</p>
          <hr>


          <!--  Image -->
          <img class="img-fluid rounded" src="post_img/post30.png" alt="post30" width="900px" height="300px">

          <hr>

          <!-- Post Content -->
          <p class="lead">It is like me ... HAHAHA</p>
		...
		%>
          ...
          <div class="media mb-4">
            <div class="media-body">
			    <h5 class="mt-0"><%= rs.getString("name") %></h5>
				<%= rs.getString("memo") %>
			</div>
          </div>
		  <hr>
